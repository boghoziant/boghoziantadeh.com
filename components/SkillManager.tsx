...
let skill_info = [
    ...
    },
    {
        title: "Misc",
        description: "",
        img_src: "code-close-up.webp ",
        img_alt: "misc image",
        tags: [
            {name: "C", bg: "bg-gradient-to-r from-blue-400 to-blue-500 "},
            {name: "C++", bg: "bg-gradient-to-r from-indigo-400 to-indigo-500 "},
            {name: "Python", bg: "bg-gradient-to-r from-blue-400 to-yellow-500 "},
            {name: "Bash", bg: "bg-gradient-to-r from-yellow-500 to-yellow-600 "},
            {name: "Java", bg: "bg-gradient-to-r from-red-400 to-red-500 "},
            {name: "JavaScript", bg: "bg-gradient-to-r from-pink-400 to-pink-500 "},
        ]
    },
];
